package hu.evocelot.file.ts.sample.rest;
...
import hu.evocelot.file.ts.sample.rest.builder.SampleRequestBuilder;
import hu.icellmobilsoft.coffee.dto.common.commonservice.FunctionCodeType;
import hu.icellmobilsoft.coffee.se.api.exception.BaseException;
import hu.icellmobilsoft.roaster.api.TestSuiteGroup;
import hu.icellmobilsoft.roaster.restassured.BaseConfigurableWeldIT;
import hu.evocelot.file.api.rest.jee10.ISampleRest;
import hu.evocelot.file.api.rest.jee10.client.ISampleRestJsonClient;
import hu.evocelot.file.api.rest.jee10.client.ISampleRestXmlClient;
...
class PostSampleJaxrsIT extends BaseConfigurableWeldIT {
    ...
    private static final String REST_CONFIG_KEY = "file.service.sample.base.uri";
