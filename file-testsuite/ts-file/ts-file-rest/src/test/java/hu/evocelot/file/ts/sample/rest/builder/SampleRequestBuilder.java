package hu.evocelot.file.ts.sample.rest.builder;

import jakarta.annotation.PostConstruct;
import jakarta.enterprise.inject.Model;

import hu.evocelot.ts.file.common.dto.DtoHelper;
import hu.icellmobilsoft.roaster.api.dto.BaseBuilder;
import hu.evocelot.file.api.sample._1_0.rest.post.SampleCoreType;
import hu.evocelot.file.api.sample._1_0.rest.post.SampleRequest;
import hu.evocelot.file.api.sample._1_0.rest.post.SampleValueEnumType;
