...
[source,bash]
----
docker cp file-services/file-service/target/file-service-<VERSION>-SNAPSHOT.war evocelot-file-service:/home/icellmobilsoft/wildfly/standalone/deployments/ROOT.war
----
